...
public class BmAgent {
    ...
    public BmAgent(Long id, String code, String agentName, String contactsName, String contactsPhone, String logoPic, String coverPic, Long provinceId, String provinceName, Long cityId, String cityName, Long adminId, String address, String about, String slogan, Integer status, Long createBy, java.util.Date createTime, Integer enable, Long lastUpdateBy, java.util.Date lastUpdateTime) {
        super();
        this.id = id;
        this.code = code;
